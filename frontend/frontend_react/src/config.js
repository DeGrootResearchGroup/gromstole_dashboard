...
const $LINEAGE_HEADERS_ENDPOINT     = process.env.REACT_APP_API_LINEAGE_HEADERS_ENDPOINT;
...
if(!$LINEAGE_HEADERS_ENDPOINT)
    throw new Error(".env is missing REACT_APP_LINEAGE_HEADERS_ENDPOINT");

if(!$LINEAGE_TRIE_ENDPOINT)
    throw new Error(".env is missing REACT_APP_LINEAGE_TRIE_ENDPOINT");

if(!$MUTATION_HEADERS_ENDPOINT)
    throw new Error(".env is missing REACT_APP_API_MUTATION_HEADERS_ENDPOINT");
